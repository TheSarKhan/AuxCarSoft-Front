...
const items = [
{
    ...
    description:
      "Every tool and system we create is optimized for performance, scalability, and efficiency—tailored to the needs of logistics and automotive businesses.",
  },
  {
    iconBg: "background-color: #ffc93c",
    title: "Fast Execution",
    description:
      "We move quickly from idea to deployment. Whether it's building features or resolving issues, our team delivers with speed and precision.",
  },
  {
    iconBg: "background-color: #f73859",
    title: "Tailored Design",
    description:
      "From UI to UX, we focus on user-friendly, brand-consistent designs that resonate with your audience and simplify complex workflows.",
  },
  {
    iconBg: "background-color: #407BFF",
    title: "Data-Driven Decision Making",
    description:
      "We empower logistics teams with real-time dashboards and analytics, enabling smarter and faster business decisions.",
  },
];
</script>
<template>
