...
const subHeading = "Insights and updates from our team and industry";
const blogItems = [
  {
    title: "How Our Auction Tracking System is Changing Logistics",
    name: "James",
    date: "Jun 14, 2020",
  ...
  {
    title: "Discover how our real-time vehicle tracking tech is streamlining imports for logistics companies.",
    name: "James",
    date: "Jun 14, 2020",
    category: "Digital Service",
  ...
  {
    title: "We share key tips from our team on building high-converting websites for logistics and importers.",
    name: "James",
    date: "Jun 14, 2020",
    category: "Digital Service",
