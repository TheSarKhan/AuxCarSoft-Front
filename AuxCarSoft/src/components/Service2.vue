...
const items = [
  {
    id: 1,
    name: "CRM Systems",
    des: "Manage your customer relationships efficiently. From lead tracking to post-sale support, our CRM tools streamline the entire customer journey.",
  },
  {
    id: 2,
    name: "Auction Tracking Systems",
    des: "Track vehicles from auction to delivery. Our smart tracking solution provides full transparency and control throughout the import process.",
  },
  {
    id: 3,
    name: "Website Development",
    des: "We build professional websites tailored for logistics and automotive businesses. Mobile-friendly, fast, and designed to reflect your brand identity.",
  },
  {
    id: 4,
    name: "Dashboard & Admin Panel",
    des: "Control your operations from a single platform. Access real-time data, manage logistics, and make informed decisions through powerful admin tools.",
  },
];
const total = 4;
</script>
