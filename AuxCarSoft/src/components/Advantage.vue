...
const subHeading = "Custom-built tools for modern vehicle import logistics.";
const buttonLearnMore = "Learn More";
const advantages = [
  {
    name: "Streamline Your Logistics",
    des: "Optimize every step — from auction pickup to final delivery. Our solutions simplify the entire process for auto importers and transporters.",
  },
  {
    name: "Develop with Precision",
    des: "Our tech stack is built specifically for the challenges of vehicle transport logistics. Stay ahead with tools made for your exact needs.",
  },
  {
    name: "Accelerate Results",
    des: "Automate time-consuming tasks, reduce errors, and ensure on-time deliveries. Experience consistent success with our smart systems.",
  },
  {
    name: "Transform Operations",
    des: "Turn outdated processes into efficient digital workflows. Bring your logistics operations to life with powerful tools built for impact.",
  },
];
</script>
